...
namespace LongZhiJie
{
    public class ClientManger : BaseManger
    {
        ...
        private const string ip = "192.168.2.164";
        ...
        private void InitSocket()
        {
            ...
            catch (Exception e)
            {
                ...
                Logging.HYLDDebug.LogError("连接失败");
        ...
        { 
            Logging.HYLDDebug.Log("开始接收  client:" + _socket.LocalEndPoint + "  ---  sever:" + _socket.RemoteEndPoint);
