...
namespace BT {
	...
	public abstract class BTNode {
		...
		// Cooldown function.
		public float interval = 0.05f;//间隔
		...
		public bool Evaluate () {
			...
			//Logging.HYLDDebug.LogError(precondition==null);
			//if(coolDownOK)
			//Logging.HYLDDebug.LogError($"Evaluate {this.GetType().ToString()}  activated={activated}   {precondition}={precondition == null || precondition.Check()} ");
